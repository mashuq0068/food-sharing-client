    ...
    <div className="card flex-shrink-0   w-[90vw] lg:max-w-4xl 2xl:max-w-6xl mx-auto shadow-2xl bg-base-100">
      <form onSubmit={handleAddFood} className="card-body">
        ...
        <div className=" md:grid gap-7 grid-cols-2">
          ...
          <input type="text" name="foodName" placeholder="Food Name" className="input  md:text-lg text-base   input-bordered" required />
        </div>
        <div className="form-control ">
          <label className="label">
            <span className="label-text md:text-lg text-base   ">Food Image</span>
          </label>
          <input type="text" name="foodImage" placeholder="Food Image" className="input  md:text-lg text-base   input-bordered" required />
        ...
        <div className=" lg:grid gap-7 grid-cols-2">
          ...
          <input type="text" name="foodQuantity" placeholder="Food Quantity" className="input   md:text-lg text-base   input-bordered" required />
        </div>
        <div className="form-control ">
          <label className="label">
            <span className="label-text md:text-lg text-base   ">Pickup Location</span>
          </label>
          <input type="text" name="pickupLocation" placeholder="Pickup Location" className="input  md:text-lg text-base   input-bordered" required />
        ...
        <div className=" md:grid gap-7 grid-cols-2">
          ...
          <input type="date" name="expiredDate" placeholder="Expired Date" className="input  md:text-lg text-base   input-bordered" required />
        </div>
        <div className="form-control ">
          <label className="label">
      ...
      <label className="label">
        ...
        <textarea  name="additionalInformation" id="" cols="30" placeholder="Additional Information" rows="10" className="input h-[20vh] px-[1%] pt-[1%]   md:text-lg text-base   input-bordered" required ></textarea>
        ...
        <div className="form-control mt-6">
          <button className="btn btn-primary text-base md:  text-black capitalize bg-yellow-400 border-none hover:bg-yellow-600">Add Food</button>
        </div>
      </form>
    </div>
  </div>
