    ...
    <div className="mt-[15vh] px-[6%] pb-[7%]">
      ...
      <div className="text-end flex justify-between">
        <form  onSubmit={handleSearch} className="flex">
          <input name="search" type="text" placeholder="Search by Food Name" className="input rounded-r-none md:text-lg text-base  2xl:text-2xl input-bordered drop-shadow-xl  w-[30vw]"/>
        <input type="submit" className="btn bg-teal-400 capitalize drop-shadow-xl hover:bg-teal-400 border-none text-2xl rounded-l-none" value="Search" />
        </form>
      <button onClick={handleSort} className="btn bg-teal-400 capitalize drop-shadow-xl shadow-xl hover:bg-teal-400 border-none text-2xl">
