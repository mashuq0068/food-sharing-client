...
const Contact = () => {
    ...
    return (
        ...
        <h3 className="text-center font-bold mt-[10vh] text-gray-600 2xl:text-4xl xl:text-3xl lg:text-2xl "><span className="text-yellow-500">Contact</span> to authority</h3>
        <div className="flex flex-col  lg:h-screen justify-start lg:justify-center items-center ani-new-page">
            ...
            <div>
       {    !openEmail && <button onClick={handleWriteEmail} className="btn text-base   text-white bg-red-500 hover:bg-yellow-500 border-none drop-shadow-xl shadow-xl capitalize ">Write Email</button>} 
