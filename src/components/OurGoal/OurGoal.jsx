...
const OurGoal = () => {
    ...
    return (
        ...
        <motion.div
           ...
           animate={controls}
         >
         <p className="2xl:text-5xl lg:text-4xl pt-[20vh]  text-teal-500 text-3xl text-center font-bold"><span className="text-gray-600">Our</span> Goal</p>
         <div className="text-center w-[80vw] lg:w-[40vw] mx-auto drop-shadow-xl shadow-xl mt-[10vh]  shadow-teal-200">
         ...
         <h3 className="2xl:text-5xl lg:text-4xl pt-[20vh]  text-teal-500 text-3xl text-center font-bold"><span className="text-gray-600">Our</span> Goal</h3>
         <div className="text-center w-[80vw] lg:w-[40vw] mx-auto drop-shadow-xl shadow-xl mt-[10vh]  shadow-teal-200">
            <p className="text-center  2xl:text-2xl text-base md:text-xl p-[4%]">
