...
const Banner = () => {
    ...
    return (
        ...
        <div className="absolute  top-[33%] lg:top-[25%] w-full">
            ...
            <p  className={`font-bold  duration-1000  md:text-3xl text-2xl lg:text-4xl 2xl:text-5xl text-center slide-from-left drop-shadow-xl d-400 relative  z-10 text-white `}>Save Food <span className={`text-yellow-400  duration-1000 slide-from-left md:text-3xl text-2xl lg:text-4xl 2xl:text-5xl `}>Save life</span></p> 
